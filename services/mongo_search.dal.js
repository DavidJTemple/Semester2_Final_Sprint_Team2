...
async function getByFamilyName(name) {
  ...
  thisEmitter.emit(
    "log",
    " -- A Mongo Census Family Name  Log Event has been Emitted!" +
      " Family Name: " +
      name
  );
...
async function getByProvince(province) {
  ...
  thisEmitter.emit(
    "log",
    " -- A Mongo Census Province  Log Event has been Emitted!" +
      " Province : " +
      province
  );
  app.set("view-engine", "ejs");
...
async function getByHouseholdId(household_id) {
  ...
  thisEmitter.emit(
    "log",
    " -- A Mongo Census Household Id  Log Event has been Emitted!" +
      " Household Id: " +
      household_id
  );
  app.set("view-engine", "ejs");
...
async function getByYear(census_year) {
  ...
  thisEmitter.emit(
    "log",
    " -- A Mongo Census Year Log Event has been Emitted!" +
      " Year: " +
      census_year
  );
  app.set("view-engine", "ejs");
